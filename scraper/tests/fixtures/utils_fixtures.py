...
ZAAK_API_RESPONSE: list[dict[str, Any]] = [
    {
        "Afgedaan": True,
        ...
        "Document": [
            {
                "Id": "doc-e106",
                "HuidigeDocumentVersie": {"ExterneIdentifier": "kst-99999-0"},
            }
        ],
    },
    {
        ...
        "GewijzigdOp": "2025-12-17T13:18:36.05+01:00",
        ...
        "Document": [
            {
                "Id": "doc-669e",
                "HuidigeDocumentVersie": {"ExterneIdentifier": "kst-99999-1"},
            }
        ],
    },
    {
        ...
        "Document": [
            {
                "Id": "doc-5434",
                "HuidigeDocumentVersie": {"ExterneIdentifier": "kst-99999-2"},
            }
        ],
    },
    {
        ...
        "Document": [
            {
                "Id": "doc-fa2d",
                "HuidigeDocumentVersie": {"ExterneIdentifier": "kst-99999-3"},
            }
        ],
    },
]
